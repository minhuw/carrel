...
export interface INotebookOriginalModelReferenceFactory {
	...
	getOrCreate(fileEntry: INotebookOriginalModelSource, viewType: string): Promise<IReference<NotebookTextModel>>;
}

export interface INotebookOriginalModelSource {
...
export class OriginalNotebookModelReferenceCollection extends ReferenceCollection<Promise<NotebookTextModel>> {
	...
	protected override async createReferencedObject(key: string, fileEntry: INotebookOriginalModelSource, viewType: string): Promise<NotebookTextModel> {
