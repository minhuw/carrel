		...
		if (props.searchResults) {
			...
			if (this.searchResultModel) {
				...
				if (rawResults[SearchResultIdx.Local] && displayIndex >= 0) {
					...
					groupId = settingInLocalResults ? 'local' : undefined;
				}
			}
		}
